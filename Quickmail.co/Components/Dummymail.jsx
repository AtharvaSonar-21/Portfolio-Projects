...
function Dummymail() {
    ...
    return (
        <div className="h-screen w-full bg-gray-200 p-4 ">
            ...
            <div className='flex p-2 bg-white w-full h-25 rounded-2xl m-2'>
                <h1><b>mail 1</b></h1> <br />
                <h2>this is the mail</h2>
            </div>
             <div className='flex p-2 m-2 bg-white w-full h-25 rounded-2xl'>
                <h1><b>mail 2</b></h1> <br />
                <h2>this is the mail</h2>
            </div>
             <div className='flex p-2 m-2 bg-white w-full h-25 rounded-2xl'>
             ...
             <div className='flex p-2 m-2 bg-white w-full h-25 rounded-2xl'>
                <h1><b>mail 2</b></h1> <br />
                <h2>this is the mail</h2>
            </div> <div className='flex p-2 m-2 bg-white w-full h-25 rounded-2xl'>
                <h1><b>mail 2</b></h1> <br />
                <h2>this is the mail</h2>
            </div>
             <div className='flex p-2 m-2 bg-white w-full h-25 rounded-2xl'>
